...
public class Routes {
    ...
    static void recRoute() {
        ...
        System.out.println("Moalboal (End)");
        System.out.println(" ");
        System.out.println("The Distance of the chosen route is: 94.0 km");
    }
    ...
    static void recRoute1() {
        ...
        System.out.println("Moalboal (End)");
        System.out.println(" ");
        System.out.println("The Distance of the chosen route is: 92.2 km");
    }
    ...
    static void recRoute3() {
        ...
        System.out.println("Moalboal (End)");
        System.out.println(" ");
        System.out.println("The Distance of the chosen route is: 84.9 km");
    }
